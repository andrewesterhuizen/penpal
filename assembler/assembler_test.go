...
var instructionTestCases = []TestCase{
	{input: "MOV A 0xab", output: instructions.MovEncode(instructions.AddressingModeImmediate, instructions.RegisterA, 0xab)},
	{input: "MOV A +1(fp)", output: instructions.MovEncode(instructions.AddressingModeFPRelative, instructions.RegisterA, 0x1)},
	{input: "MOV A -1(fp)", output: instructions.MovEncode(instructions.AddressingModeFPRelative, instructions.RegisterA, 0xff)},
	{input: "MOV B 0xcd", output: instructions.MovEncode(instructions.AddressingModeImmediate, instructions.RegisterB, 0xcd)},
	...
	{input: "$test = 0xbc\nMOV A $test\n", output: instructions.MovEncode(instructions.AddressingModeImmediate, instructions.RegisterA, 0xbc)},
	{input: "$test = 0xabcd\nMOV A $test\n", output: instructions.MovEncode(instructions.AddressingModeImmediate, instructions.RegisterA, 0xcd)},
	{input: "$test = 0xbc\nMOV A $test\n", output: instructions.MovEncode(instructions.AddressingModeImmediate, instructions.RegisterA, 0xbc)},
	{input: "$test = 0xabcd\nMOV A $test\n", output: instructions.MovEncode(instructions.AddressingModeImmediate, instructions.RegisterA, 0xcd)},
